...
- Skim [P4DS: CH13 Exploratory Data Analysis](https://aeturrell.github.io/python4DS/exploratory-data-analysis.html) to see many different possible geoms to use depending on the data types and to see some of the commands from CH4 again. 
